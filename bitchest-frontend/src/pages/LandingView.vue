...
const progressBarStyle = { background: 'transparent' };
...
@keyframes button-glow {
  0%, 100% { box-shadow: 0 8px 32px rgba(53, 167, 255, 0.4), 0 0 20px rgba(56, 97, 140, 0.3); }
  50% { box-shadow: 0 8px 40px rgba(53, 167, 255, 0.6), 0 0 30px rgba(1, 255, 25, 0.4); }
}

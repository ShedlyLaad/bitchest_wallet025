  ...
  <div class="min-h-screen bg-gray-900 text-white flex relative overflow-hidden">
    ...
    <div class="hidden lg:flex flex-1 items-center justify-center p-8 relative z-10">
      <div class="max-w-md space-y-8 w-full">
        ...
        <div class="group relative bg-gradient-to-br from-blue-600/20 to-blue-800/10 border border-blue-600/30 rounded-xl p-6 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
          <div class="flex items-center space-x-3 mb-3">
            <div class="p-2 bg-blue-500/20 rounded-lg group-hover:bg-blue-500/30 transition-colors">
              <ShieldIcon class="h-5 w-5 text-blue-400" />
            </div>
            <span class="font-semibold text-white">Enhanced Security</span>
          </div>
...
import { Eye, EyeOff, Lock, Mail, Shield, Smartphone, AlertCircle } from 'lucide-vue-next';

...
<body>
  ...
  <div class="card">
    ...
    <h2 style="margin:18px 0 8px; color:#fff;">Welcome {{ $name }}</h2>
    <p>Your Bit-Chest account was created. It is currently <span class="badge">pending activation</span>.</p>

    <p>Temporary password:</p>
    <div class="box">{{ $password }}</div>

    <p class="muted" style="margin-top:10px;">For security, sign in and change your password right away.</p>

    <p style="margin:18px 0 12px;">After admin activation, your wallet will be credited with <strong>€500</strong> to help you start.</p>

    <p class="muted" style="margin-top:10px;">Welcome aboard! Your account will be reviewed shortly.</p>

    <p class="muted" style="margin-top:20px;">If you didn’t request this, please ignore this email.</p>

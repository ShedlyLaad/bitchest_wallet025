...
<body>
  ...
  <div class="card">
    ...
    <h2 style="margin:18px 0 8px; color:#fff;">Your temporary password</h2>
    <p>Hello {{ $name ?? 'User' }},</p>

    <p>Here is your temporary password (8 digits). Use it to sign in, then change it immediately.</p>
    <p class="muted" style="margin-top:8px;">After you change it, your account will move to admin validation.</p>
    <div class="box">{{ $password }}</div>

    <p class="muted" style="margin-top:16px;">This password is sensitive. Do not share it.</p>
